...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DataSource_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_DataSource_t qt_meta_stringdata_DataSource = {
    {
QT_MOC_LITERAL(0, 10) // "DataSource"
...
const QMetaObject DataSource::staticMetaObject = { {
    ...
    qt_meta_stringdata_DataSource.offsetsAndSize,
    qt_meta_data_DataSource,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DataSource_t
